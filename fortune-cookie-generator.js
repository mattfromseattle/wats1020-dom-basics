...
var generateFortuneCookie = function() {
    ...
    var previousFortunesContainer = document.getElementById('previous-fortunes-list');
    previousFortunesContainer.appendChild(newListItem);
    ...
    fortuneContainer.innerHTML = fortunesList[Math.floor(Math.random() * fortunesList.length)];
    fortunesList.splice();
